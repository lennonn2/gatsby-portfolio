  ...
  <div className={styles.app}>
    ...
    <section className={styles.body}>
      ...
      <div className={styles.icons}>
        <a href="https://github.com/lennonn2" className={styles.linkIcon}><FaGithub className={styles.iconGH} /></a>
        <a href="https://www.linkedin.com/in/nialllennon2/" className={styles.linkIcon}><FaLinkedinIn className={styles.iconLI} /></a>
      </div>
    </section>
  </div>
);
